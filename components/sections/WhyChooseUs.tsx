...
const reasons = [
  {
    ...
    className: "lg:col-span-2 lg:row-span-1", // Larger card
  },
  {
    icon: <Shield size={22} />,
    title: "Future Proof",
...
const WhyChooseUs = () => {
  return (
    <section className="px-6 md:px-12 py-32 bg-black relative overflow-hidden" id="story-section">
      {/* 1. Title Div */}
      <div className="max-w-7xl mx-auto mb-20">
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-8">
          ...
          <p className="max-w-xs text-zinc-500 font-mono text-[11px] uppercase leading-relaxed tracking-wider">
            We merge brutalist aesthetics with high-performance engineering to build the next generation of digital products.
          </p>
        </div>
          ...
          >
            ...
            <div className="relative z-10 h-full flex flex-col">
              ...
              <div className="mt-auto space-y-4">
                ...
                <p className="text-zinc-500 font-mono text-[12px] uppercase leading-relaxed tracking-widest opacity-60 group-hover:opacity-100 transition-opacity duration-500 max-w-sm">
                  {r.desc}
                </p>
              </div>
            </div>
